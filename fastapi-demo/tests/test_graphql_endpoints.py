...
class TestGraphQLEndpoints:
    @pytest.mark.asyncio
    async def test_graphql_get_all_orders_query(self, client):
        query = """
        query {
            getAllOrders {
                orderId
    ...
    @pytest.mark.asyncio
    async def test_graphql_create_order_mutation(self, client, test_order_data):
        mutation = """
    ...
    @pytest.mark.asyncio
    async def test_graphql_get_order_by_id_query(self, client, test_order_data):
        mutation = """
        mutation CreateOrder($order: OrderCreateInputGraphQL!) {
            createOrder(order: $order) {
                orderId
    ...
    @pytest.mark.asyncio
    async def test_graphql_get_orders_by_user_id_query(self, client, test_order_data):
        mutation = """
        mutation CreateOrder($order: OrderCreateInputGraphQL!) {
            createOrder(order: $order) {
                orderId
    ...
    @pytest.mark.asyncio
    async def test_graphql_update_order_mutation(self, client, test_order_data):
        create_mutation = """
        mutation CreateOrder($order: OrderCreateInputGraphQL!) {
            createOrder(order: $order) {
                orderId
    ...
    @pytest.mark.asyncio
    async def test_graphql_delete_order_mutation(self, client, test_order_data):
        create_mutation = """
        mutation CreateOrder($order: OrderCreateInputGraphQL!) {
            createOrder(order: $order) {
                orderId
